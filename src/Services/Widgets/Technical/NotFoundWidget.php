...
/**
 * Rendered when widget was not found
 */
#[AsStaticWidget(
...
class NotFoundWidget extends AbstractWidget
{
    ...
    public function getDescriptor(): SimpleDescriptor
    {
        return new TranslatableDescriptor(
            title: "widgets.technical.not-found.title",
            description: "widgets.technical.not-found.description",
    ...
    public function build() : void
    {
        ...
        $textBlock
            ->setText(sprintf(
                ...
                $this->translator->trans("widgets.technical.not-found.text", array(), "BadPixxelWidgets")
            ))
