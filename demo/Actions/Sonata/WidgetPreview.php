...
/**
 * Show Preview of a Single Widget using Sonata Blocks
 */
#[Route(
    path: "/sonata/widgets/{hash}/preview",
    name: WidgetsDemoRoutes::SONATA_WIDGET_PREVIEW
)]
class WidgetPreview extends AbstractController
{
    ...
    public function __invoke(string $hash) : Response
    {
        ...
        return $this->render('@WidgetsDemo/Sonata/Widgets/preview.html.twig', array(
            'Hash' => $hash,
